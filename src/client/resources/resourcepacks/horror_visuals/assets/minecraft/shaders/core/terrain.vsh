...
// World position wrapped to 4096 blocks: float-precise anywhere, and the material noise tiles at that period.
...
void main() {
    ...
    #endif
    texCoord0 = UV0;
    worldPos = vec3(ChunkPosition & ivec3(4095)) + Position;
